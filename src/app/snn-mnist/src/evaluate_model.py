...
def evaluate_model(data_loader, weights_input_to_hidden, weights_hidden_to_output):
    ...
    for images, labels in data_loader:
        ...
        for t in range(num_time_steps):
            ...
            spikes_hidden, membrane_potential_hidden, _ = lif_step(current_input_hidden, membrane_potential_hidden, membrane_decay)

            current_input_output = spikes_hidden @ weights_hidden_to_output
            spikes_output, membrane_potential_output, _ = lif_step(current_input_output, membrane_potential_output, membrane_decay)
